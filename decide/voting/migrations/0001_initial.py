# Generated by Django 4.1 on 2023-12-19 17:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('C', 'Classic question'), ('Y', 'Yes/No question'), ('M', 'Multiple choice question'), ('T', 'Text question'), ('R', 'Ranked question')], default='C', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Voting',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='yesno_options', to='voting.question')),
            ],
        ),
        migrations.CreateModel(
